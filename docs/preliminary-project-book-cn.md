...
- 完成项目书和报名。
- 发布中文路演网站。
- 完成模拟 dashboard 和训练任务规范。
- 准备 fallback demo，不依赖真实开发板。

### 复赛入围后

- 拿到开发板后完成 board bring-up。
- 接入摄像头、传感器和机器人 IO。
- 录制真实 episode 并转换为 LeRobot-compatible dataset。
- 运行一次中国或海外云端 ACT 训练。
